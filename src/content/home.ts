/**
 * content/home.ts
 * Static content data for the Home page.
 * Moved from src/data/home.tsx → src/content/home.ts
 */
...
export const testimonials = [
  {
    quote: "Neal Foundation creates real opportunities for people who need support most.",
    name: "Community Partner",
    role: "Ahmedabad",
  },
  {
    quote: "The team brings care, discipline, and warmth to every outreach initiative.",
    name: "Volunteer Lead",
    role: "Neal Foundation",
  },
  {
    quote: "Their programs make giving back feel organized, useful, and deeply human.",
    name: "Donor Partner",
    role: "India",
  },
]
...
export const marqueeItems = [
  {
    ...
    description: "Give your time, skills, and compassion to create meaningful change in communities.",
    icon: UsersRound,
  },
  {
    id: 2,
    title: "Helping Each Other",
    description: "Together, we can support people in need and build stronger, caring communities.",
    icon: HeartHandshake,
  },
  {
    id: 3,
    title: "Start Donating",
    description: "Your contribution helps us provide essential support and create lasting impact.",
    icon: HandCoins,
  },
  {
    id: 4,
    title: "Support Education",
    description: "Help children access quality education, learning resources, and better opportunities.",
    icon: GraduationCap,
  },
  {
    id: 5,
    title: "Improve Healthcare",
    description: "Support healthcare initiatives that provide treatment, awareness, and medical assistance.",
    icon: Stethoscope,
  },
  {
    id: 6,
    title: "Provide Healthy Meals",
    description: "Help us provide nutritious meals to families and individuals facing food insecurity.",
    icon: Utensils,
  },
  {
    id: 7,
    title: "Shelter the Homeless",
    description: "Support safe shelter, essential resources, and rehabilitation for homeless individuals.",
    icon: Home,
  },
  {
    id: 8,
    title: "Care for Communities",
    description: "Join community programs focused on dignity, inclusion, care, and sustainable development.",
    icon: HandHeart,
  },
  {
    id: 9,
    title: "Protect Our Environment",
    description: "Participate in environmental initiatives that promote cleaner and greener communities.",
    icon: Leaf,
  },
  {
    id: 10,
    title: "Empower Every Child",
    description: "Support programs that protect children and help them grow with confidence and opportunity.",
    icon: Baby,
  },
]
