...
import { ArrowRight, Sparkles, BookOpen, Users2, Lightbulb, Award } from "lucide-react";
  ...
  const initiatives = [
    {
      ...
      desc: "Access to quality education through learning centers, tutoring, and educational resources.",
    },
    {
      icon: Lightbulb,
      title: "Skill Building",
      desc: "Development of critical thinking, problem-solving, and vocational skills for children.",
    },
    {
      icon: Users2,
      title: "Mentorship",
      desc: "One-on-one and group mentoring to guide children's personal and academic growth.",
    },
    {
      icon: Award,
      title: "Scholarships",
      desc: "Financial support and scholarships to remove barriers to education for disadvantaged children.",
    },
  ];
      ...
      <section className="relative flex min-h-[100vh] items-end overflow-hidden bg-background pb-20 pt-36">
        ...
        <div className="container relative z-10 mx-auto px-6 lg:px-8">
          ...
          >
            ...
            >
              Investing in - <span className="text-gradient-brand"> Tomorrow's Leaders</span>
            </motion.h1>
            ...
            >
              Education is the foundation for breaking cycles of poverty and empowering children to reach their full potential. Neal Foundation provides comprehensive educational support to children in underserved communities.
            </motion.p>
      ...
      <section className="relative overflow-hidden bg-background py-28 lg:py-32">
        ...
        <div className="container relative z-10 mx-auto px-6 lg:px-8">
          ...
          >
            ...
            >
              Building Brighter <em className="not-italic text-primary">Futures</em>
            </motion.h2>
        ...
        <div className="container relative z-10 mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative z-10 mx-auto max-w-3xl space-y-7">
              <SectionLabel>Transform Lives Through Education</SectionLabel>

              <h2 className="font-serif text-3xl font-bold leading-[1.06] text-foreground sm:text-4xl lg:text-5xl">
                Help a Child <br />
                <em className="not-italic text-primary">Reach Their Potential</em>
              </h2>

              <p className="mx-auto max-w-2xl text-base font-light leading-relaxed text-muted-foreground">
                Your contribution provides educational resources, mentorship, and support that changes children's lives and creates lasting impact for entire communities.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4 pt-2">
                ...
                >
                  <Link href="/contact">
                    Sponsor a Child <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
