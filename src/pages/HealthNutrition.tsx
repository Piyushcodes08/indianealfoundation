...
import { ArrowRight, Sparkles, Heart, Apple, Users2, Stethoscope } from "lucide-react";
  ...
  const initiatives = [
    {
      ...
      desc: "Regular health camps providing free medical checkups, screenings, and preventive care.",
    },
    {
      icon: Apple,
      title: "Nutrition Programs",
      desc: "Balanced nutrition initiatives and meal programs for children and mothers in need.",
    },
    {
      icon: Stethoscope,
      title: "Medical Support",
      desc: "Financial assistance for medical treatments and access to healthcare services.",
    },
    {
      icon: Users2,
      title: "Health Awareness",
      desc: "Community education on hygiene, nutrition, disease prevention, and wellness.",
    },
  ];
      ...
      <section className="relative overflow-hidden bg-background py-28 lg:py-32">
        ...
        <div className="container relative z-10 mx-auto px-6 lg:px-8">
          ...
          >
            ...
            >
              Promoting Health & <em className="not-italic text-primary">Wellness</em>
            </motion.h2>
        ...
        <div className="container relative z-10 mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative z-10 mx-auto max-w-3xl space-y-7">
              <SectionLabel>Invest in Community Health</SectionLabel>

              <h2 className="font-serif text-3xl font-bold leading-[1.06] text-foreground sm:text-4xl lg:text-5xl">
                Support Health <br />
                <em className="not-italic text-primary">Initiatives Today</em>
              </h2>

              <p className="mx-auto max-w-2xl text-base font-light leading-relaxed text-muted-foreground">
                Your support ensures vulnerable communities receive healthcare, nutrition, and health education needed for a healthier, happier future.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4 pt-2">
                ...
                >
                  <Link href="/contact">
                    Support Health Programs <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
